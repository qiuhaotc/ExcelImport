...
namespace DAL
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static string connectionString = ConfigurationManager.ConnectionStrings["DbConnString"].ConnectionString;

        //ConfigurationManager.ConnectionStrings["DbConnString"].ConnectionString;
        //"Data Source=192.168.1.4;Initial Catalog=lwdx_pms;Persist Security Info=True;User ID=lwdx_pms;Password=lwdx_pms";
        public SqlHelper()
        {
        ...
        #endregion 读取第一行第一列数据 + ExecuteScalar方法
        ...
        #endregion MyRegion 为执行命令准备参数 - PrepareCommand(SqlCommand cmd, SqlConnection conn, SqlTransaction trans, CommandType cmdType, string cmdText, SqlParameter[] cmdParms)
